...
class Amocrm(object):
    ...
    def get_leads(self, limit_rows: int = 500, limit_offset: int = 0, id: Union[list, int, None] = None,
        ...
        if responsible_user_id is not None:
            params['responsible_user_id'] = ','.join(i for i in responsible_user_id) if isinstance(
                responsible_user_id, list) \
    ...
    def create_or_create_contacts(self, add: Optional[list] = None, update: Optional[list] = None) -> dict:
        """
    ...
    def get_contacts(self, limit_rows: int = 500, limit_offset: int = 0, id: Union[int, list, None] = None,
                     responsible_user_id: Union[list, int, None] = None, query: Optional[str] = None) -> dict:
        """
         doc - https://www.amocrm.ru/developers/content/api/contacts
        :param limit_rows: int (limit of rows, default=500)
        :param limit_offset: int (offset, default=0)
    ...
    def create_or_update_companies(self, add: Optional[list] = None, update: Optional[list] = None) -> dict:
        """
    ...
    def get_companies(self, limit_rows: int = 500, limit_offset: int = 0, id: Union[int, list, None] = None,
                      responsible_user_id: Union[list, int, None] = None, query: Optional[str] = None) -> dict:
        """
         doc - https://www.amocrm.ru/developers/content/api/companies
        :param limit_rows: int (limit of rows, default=500)
    ...
    def create_or_update_customers(self, add: Optional[list] = None, update: Optional[list] = None) -> dict:
        """
    ...
    def get_customers(self, limit_rows: int = 500, limit_offset: int = 0) -> dict:  # TODO: filters
        """
    ...
    def get_transactions(self, limit_rows: int = 500, limit_offset: int = 0, id: Optional[int] = None,
    ...
    def get_tasks(self, limit_rows: int = 500, limit_offset: int = 0, id: Optional[int] = None,
                  element_id: Optional[int] = None, responsible_user_id: Optional[int] = None,
                  type: Optional[str] = None) -> dict:  # TODO: filters
        """
        doc - https://www.amocrm.ru/developers/content/api/tasks
        :param limit_rows: int
        :param limit_offset: int
    ...
    def create_or_update_notes(self, add: Optional[list] = None, update: Optional[list] = None) -> dict:
        """
    ...
    def get_notes(self, type, limit_rows: int = 500, limit_offset: int = 0, id: Optional[int] = None,
                  element_id: Optional[int] = None, note_type: Optional[int] = None,
    ...
    def get_incoming_leads(self, page_size: int = 500, page: int = 1, categories: Optional[list] = None,
                           order_by: str = 'asc', pipeline_id: Optional[int] = None) -> dict:
        """
        :param page_size: int
        :param page: int
